...
$mail->Subject = "Bestätigung des gebuchten Kurses.";
$mail->Body = "Liebe(r) " . $name . ",\n\n"
            . "Vielen Dank für deine Anmeldung!\n\n"
            . "Bitte nehme die €120.- direkt zum Kurstag mit & speichere das E-Mail ab.\n\n"
            ...
            <div class="row g-0">
                <div class="col-md-24">
                    <div class="video bg-dark align-items-center">
                        ...
                        <h5 class="section-title ff-secondary text-start text-rgba(15, 26, 43, .5) fw-normal">Kochkurs</h5>
                        <h1 class="text-rgba(15, 26, 43, .5) mb-4 ">Bestätigung des gebuchten Kurses.</h1>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <h4>.</h4>
                                    <h4>Bitte nehme die €120.- direkt zum Kurstag mit & speichere das E-Mail ab.</h4>
                                    <h4>.</h4>
                                    <h4>Ich freue mich auf dich,</h4>
                                    <h4>.</h4>
                                    <h4>Beste Grüβe,</h4>
