        ...
        <div class="container-xxl pt-5 pb-3">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Update Contact info on website</h5>
...
?>
<!-- <option value="" class="text-dark"><?php //echo $row["name"]; ?></option> -->


        <!-- Banner Start -->
        <form action="admin/php_contact.php" method="post" id="contact">
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="email" name="email" class="form-control" value="<?php echo $row["info"]; ?>">
