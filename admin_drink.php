...
<body>
    ...
    <div class="container-xxl bg-white p-0">
                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-primary active" aria-current="page">Drinks</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl pt-5 pb-3">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Add Drink in Menu</h5>
        ...
        <!-- add  drink  Start -->
        <form action="admin/php_drinkadd.php" method="post" enctype="multipart/form-data" id="events">
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="form-floating">
                                <input type="text" name="VolCost" class="form-control" value="0.33l - 3.60">
                                ...
                                <h2 class="text-primary">
                                    <select name="class" id="class" required>
                                        <?php
                                            ...
                                            $p_0 = "SELECT DISTINCT class FROM drinks";
                                            ...
                                            for($i=1; $i<=$row_count; $i++)
                                            {
                                                $row = mysqli_fetch_array($result);
                                        ?>
                                           <option value="<?php echo $row["class"]; ?>" class="text-dark"><?php echo $row["class"]; ?></option>
                                        <?php
                                           }
                                        ?>
                                    </select> 
