        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Kontakt Uns</h1>
            ...
            <div class="row g-0">
                <div class="col-md-24">
                    <div class="video bg-dark align-items-center">
                        ...
                        <h5 class="section-title ff-secondary text-start text-rgba(15, 26, 43, .5) fw-normal">Contacting us through online plateform !</h5>
                        <h1 class="text-rgba(15, 26, 43, .5) mb-4 ">Your Message has been sent Successfully.</h1>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <h4>Great ! your message have arrived, After read it, I will reply you as soon as possible.</h4>
                                    <h4>Best Regards,</h4>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="TableTermConditions.php?page=contact_done.php">Allgemeine Geschäftsbedingungen</a>
                    </div>
                    <?php 
