            ...
            <div class="row g-0">
                <div class="col-md-24">
                    <div class="video bg-dark align-items-center">
                        ...
                        <!-- <h5 class="section-title ff-secondary text-start text-rgba(15, 26, 43, .5) fw-normal">Impressum</h5> -->
                        <h1 class="text-rgba(15, 26, 43, .5) mb-4 ">Impressum</h1>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-12">


                                    <h4>Angaben gemäß Informationspflicht laut §5 E-Commerce Gesetz, §14 Unternehmensgesetzbuch, §63 Gewerbeordnung und Offenlegungspflicht laut §25 Mediengesetz.</h4>
                                    <h4> </h4>
                                    <h4>Jay O Food</h4>
                                    <h4>Jennifer Ofori</h4>
                                    <h4>Götschka 69,</h4>
                                    <h4>4212 Neumarkt im Mühlkreis,</h4>
                                    <h4>Österreich</h4>
                                    <h4> </h4>
                                    <h4><b>Unternehmensgegenstand:</b> Gastronomie</h4>
                                    <h4><b>UID-Nummer:</b> ATU75344227</h4>
                                    <h4> </h4>
                                    <h4><b>Tel.:</b> 0664 99491040</h4>
                                    <h4><b>E-Mail: :</b> info@jayo.at</h4>
                                    
                                    <h4><b>Mitglied bei: </b> WKO</h4>
                                    <h4><b>Berufsrecht:</b> Gewerbeordnung: www.ris.bka.gv.at</h4>

                                    <h4><b>Aufsichtsbehörde/Gewerbebehörde:</b> Bezirkshauptmannschaft Freistadt</h4>

                                    <h4><b>Berufsbezeichnung:</b> Köchin</h4>
                                    <h4><b>Verleihungsstaat:</b> Österreich</h4>

                                    <h5>Verbraucher haben die Möglichkeit, Beschwerden an die OnlineStreitbeilegungsplattform der EU zu richten: http://ec.europa.eu/odr. Sie können allfällige Beschwerde auch an die oben angegebene E-Mail-Adresse richten.</h5>
                                    
                                </div>                                
                               <!--  <label>
                                    <input type="checkbox" name="agree"  class="text-rgba(15, 26, 43, .5) mb-4 "> Ich akzeptiere die allgemeinen Geschäftsbedingungen.
                                </label>
                                <div class="col-15">
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="TableTermConditions.php?page=Impressum.php">Allgemeine Geschäftsbedingungen</a>
                    </div>
                    <?php 
