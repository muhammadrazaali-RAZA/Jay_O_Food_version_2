        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Catering Buchung</h1>
        ...
        <div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
           <div class="col-md-12 bg-dark align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Booking für Catering </h5>
                        <h1 class="text-white mb-4">Catering Buchung online</h1>
                        <form action="cater_booked.php" method="post" id="booking">
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <h1 class="text-primary">Menü :
                                        <select name="menu" id="menu" required>
                                          <!-- <option value="Select">Auswählen</option> -->
                                           <option value="Kleinigkeit Snacks" class="text-dark">Kleinigkeit / Snacks</option>
                                           <option value="Hauptspeise" class="text-dark">Hauptspeise</option>
                                           <option value="2 Gänge menü" class="text-dark">2 Gänge menü</option>
                                           <option value="3 Gänge menü" class="text-dark">3 Gänge menü</option>
                                     </select> 
                                    </h1>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        ...
                                        <label for="message">Spezielle Anfragen / adresse</label>
                                    </div>
                                </div>
                                <label>
                                    <p class="text-primary"><input type="checkbox" name="agree"  class="text-rgba(15, 26, 43, .5) mb-4" required>  Ich akzeptiere die <a href="CateringTermConditions.php"><b><u>Allgemeinen Geschäftsbedingungen.</u></b></a></p>
                                </label>
                                <div class="col-12">
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="TableTermConditions.php?page=CateringBooking.php">Allgemeine Geschäftsbedingungen</a>
                    </div>
                    <?php 
