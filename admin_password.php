...
<body>
    ...
    <div class="container-xxl bg-white p-0">
                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-primary active" aria-current="page">Password</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl pt-5 pb-3">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Change your Account Password</h5>
        ...
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($newPassword == $confirmPassword) {
                    // Passwords match, you can proceed to update the password in your database
                    ...
                    $sql = "UPDATE admin SET pass = '$newPassword' WHERE name = '$name'";
                    ...
                    // Remember to hash the new password and update your database securely
                } else {
        ...
        <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
            ...
            <div class="col-12">
                <input class="btn btn-primary w-100 py-3" type="submit" value="Change Password">
            </div>
        </form>
        <!-- Password End -->
