                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-primary active" aria-current="page">Contact Info</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl pt-5 pb-3">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Update Resturant open & Close Timing</h5>
...
?>
        ...
        <!-- Banner Start -->
        <form action="admin/php_restiming.php" method="post" id="contact">
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="dienstag" class="form-control" value="<?php echo $row['dienstag']; ?>">
                                <label for="dienstag">Dienstag:</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="mittwoch" class="form-control" value="<?php echo $row['mittwoch']; ?>">
                                <label for="mittwoch">Mittwoch:</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="donnerstag" class="form-control" value="<?php echo $row['donnerstag']; ?>">
                                <label for="donnerstag">Donnerstag:</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="freitag" class="form-control" value="<?php echo $row['freitag']; ?>">
                                <label for="freitag">Freitag:</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="samstag" class="form-control" value="<?php echo $row['samstag']; ?>">
                                <label for="samstag">Samstag:</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="feiertag" class="form-control" value="<?php echo $row['feiertag']; ?>">
                                <label for="feiertag">Feiertag:</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="mon_sonn" class="form-control" value="<?php echo $row['mon_sonn']; ?>">
                                <label for="mon_sonn">Mon & Sonntag:</label>
                            </div>
                        </div>
                    </div>
                </div>
