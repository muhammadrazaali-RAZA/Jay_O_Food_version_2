                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-primary active" aria-current="page">Banner</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl pt-5 pb-3">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Ads on website</h5>
                ...
                <div class="container">
                    <div class="row g-4">
                        <div class="col-lg-6 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                            <h3 class="text-dark mb-4">Banner 1</h3>
                            <h1 class="text-primary">Event :
                                <select name="banner1" id="banner1" >
                                    ...
                                    ?>
                                   <option value="<?php echo $row["imgname"]; ?>" class="text-dark"><?php echo $row["name"]; ?></option>
                                   <?php
                                        }
                                    ?>
                             </select> 
                        ...
                        <div class="col-lg-6 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                             <h3 class="text-dark mb-4">Banner 2</h3>
                            <h1 class="text-primary">Event :
