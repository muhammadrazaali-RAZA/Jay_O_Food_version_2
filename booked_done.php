...
$mail->Subject = "Vorläufige Bestätigung der Tischreservierung";
$mail->Body = "Liebe(r) " . $name . ",\n\n"
            . "Wir freuen uns, Sie am " . $res_date . " unter dem Namen " . $name . " in unserem Lokal begrüßen zu dürfen. Dies ist eine vorläufige Bestätigung für Ihre Reservierung bei Jay O Food. \n\n"
            . "Wir überprüfen gerade unsere freien Tische und melden uns umgehend bei Ihnen und sie erhalten die endgültige Bestätigung Ihrer Reservierung.\n\n"
            . "Vielen Dank,\n"
            . "Jennifer Ofori" . "\n"
            . "Jay O Food" . "\n"
        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Table Booked</h1>
            ...
            <div class="row g-0">
                <div class="col-md-24">
                    <div class="video bg-dark align-items-center">
                        ...
                        <h1 class="text-rgba(15, 26, 43, .5) mb-4 ">Vorläufige Bestätigung der Tischreservierung.</h1>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <h4>.</h4>
                                    <h4>.</h4>
                                    <h4>Wir freuen uns, Sie am  <?php echo $res_date; ?> unter dem Namen <?php echo $name; ?> in unserem Lokal begrüßen zu dürfen. Dies ist eine vorläufige Bestätigung für Ihre Reservierung bei Jay O Food. </h4>
                                    <h4>.</h4>
                                    <h4>Wir überprüfen gerade unsere freien Tische und melden uns umgehend bei Ihnen und sie erhalten die endgültige Bestätigung Ihrer Reservierung.</h4>
                                    <h4>.</h4>
                                    <h4>.</h4>
                                    <h4>Beste Grüβe,</h4>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="TableTermConditions.php?page=book_done.php">Allgemeine Geschäftsbedingungen</a>
                    </div>
                    <?php 
