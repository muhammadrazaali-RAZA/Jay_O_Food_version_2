...
<body>
    ...
    <div class="container-xxl bg-white p-0">
                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-primary active" aria-current="page">Tischreservierung Confirm</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl pt-5 pb-3">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">online Table Reservation Booking Confirm</h5>
        ...
        <!-- Banner Start -->
        <!-- <form action="admin/php_banner.php" method="post" id="banners"> -->
            <div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
               <div class="col-md-12 bg-dark align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h3 class="text-white mb-4">Requests for Table Reservation</h3>

                            <div style="width:100%; margin: auto;">
                                <h1>Surprise, Table is Below</h1>
                                <table class="table">
                                    <thead>
                                      <tr class="section secondary text-primary fw-normal">
                                        <th>Thread-Time</th>
                                        <th>Name</th>
                                        <th>E-mail</th>
                                        <th>Reservation</th>
