...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Kochkurs</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Kochkurs</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            ...
                            <div class="p-4">
                                ...
                                <h6><?php echo $row["couseDay"]; ?></h6>
                                <h6><?php echo $row["timing"]; ?></h6>
                                <h6><?php echo $row["benefits"]; ?></h6>
        ...
        <!-- Service End -->
                ...
                <!-- Reservation for Master Courses -->
        <div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
           <div class="col-md-12 bg-dark align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h3 class="section-title ff-secondary text-start text-primary fw-normal">Anmeldung für Kochkurs</h3>
                        <h3 class="text-white mb-4">Fülle deine Daten ein</h3>
                        <form action="intern_booked.php" method="post" id="booking">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <h1 class="text-primary">Kochkurs :
                                        <select name="class_date" id="class_date" required>
                                            <?php
                                                ...
                                                for($i=1; $i<=$row_count; $i++)
                                                {
                                                    $row = mysqli_fetch_array($result);
                                            ?>
                                               <option value="<?php echo $row["event"]; ?>" class="text-dark"><?php echo $row["event"]; ?></option>
                                            <?php
                                               }
                                            ?>
                                        </select> 
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" name="address" placeholder="Special Request" id="message" style="height: 100px"></textarea>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="TableTermConditions.php?page=apply_intern.php">Allgemeine Geschäftsbedingungen</a>
                    </div>
                    <?php 
