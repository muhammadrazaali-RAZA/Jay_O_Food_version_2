        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Kontakt Uns</h5>
                    <h1 class="mb-5">Kontaktiert uns für Fragen</h1>
                </div>
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                            <div class="col-md-4">
                                <h5 class="section-title ff-secondary fw-normal text-start text-primary">Reservierung</h5>
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>Reservierung@jayo.at</p>
                            </div>
                            <div class="col-md-4">
                                <h5 class="section-title ff-secondary fw-normal text-start text-primary">Allgemein</h5>
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>info@jayo.at</p>
                            </div>
                            <div class="col-md-4">
                                <h5 class="section-title ff-secondary fw-normal text-start text-primary">Anliegen</h5>
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>info@jayo.at</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                        <iframe class="position-relative rounded w-100 h-100"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1460.452019132213!2d14.487033363245837!3d48.39862948145299!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4773a1d2cec02a97%3A0xac21f22c1762d825!2sJay%20O%20afrikanischer%20Imbiss!5e1!3m2!1sen!2sat!4v1688506112939!5m2!1sen!2sat"
                            frameborder="0" style="min-height: 350px; border:0;" allowfullscreen="" aria-hidden="false"
                            tabindex="0"></iframe>
                    </div>
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form action="contact_php.php" method="post" id="contact">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="txt" placeholder="Leave a message here" id="message" style="height: 150px"></textarea>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="TableTermConditions.php?page=contact.php">Allgemeine Geschäftsbedingungen</a>
                    </div>
                    <?php 
