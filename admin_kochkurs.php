...
<body>
    ...
    <div class="container-xxl bg-white p-0">
                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-primary active" aria-current="page">Kochkurs</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-12 text-center">
                                <div class="d-flex align-items-center">
                                    ...
                                    <h2  style="color: #ff9900; font-family: 'Helvetica Neue', sans-serif; font-size: 98px; font-weight: bold; letter-spacing: -1px; line-height: 1; text-align: center;">Courses Listed</h2>
                                </div>
                            </div>
                            <?php
                            ...
                            <div class="col-lg-6">
                                <div class="service-item rounded pt-3">
                                    <form method='post' action='admin/php_delete_kochkurs.php'>
                                        <div class="p-4">
                                            <img src="img/icons/training.png" alt="Logo" width="100" height="100">
                                            <input type='hidden' name='id' value='<?php echo $row['id']; ?>'>
                                                <button class="btn btn-primary" type="submit">Delete</button> 
                                            <h4 class="ff-secondary text-start text-primary fw-normal mb-4">Kochkurs     -     Datum: <?php echo $row["event"]; ?></h4>
                                            <h6 class="text-white"><?php echo $row["cost"]; ?></h6>
                                            <h6 class="text-white"><?php echo $row["couseDay"]; ?></h6>
                                            <h6 class="text-white"><?php echo $row["timing"]; ?></h6>
                                            <h6 class="text-white"><?php echo $row["benefits"]; ?></h6>
                                            <h6 class="text-start text-primary mb-6"><?php echo $row["info"]; ?></h6>
                                        </div>
                                    </form>
                                </div>
                            </div>
        ...
        <div class="container-xxl pt-5 pb-3">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Add Master Course on website</h5>
        ...
        <!-- add  event  Start -->
        <form action="admin/php_kochkurs.php" method="post">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="form-floating">
                                <input type="text" name="cost" class="form-control" value="* Kosten - 120 €" required>
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="form-floating">
                                <input type="text" name="days" class="form-control" value="* Ein Tages Kurs" required>
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="form-floating">
                                <input type="text" name="duration" class="form-control" value="* Beginn: 09:00 Ende: ca. 15:00" required>
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="form-floating">
                                <input type="text" name="benefits" class="form-control" value="* Inklusive: Getränke, Essen, Rezepte" required>
                        ...
                        <div class="col-12 wow fadeInUp" data-wow-delay="0.6s">
                            <div class="form-floating">
                                <input class="form-control" name="detail" value="Füge deine Daten für die Anmeldung in den untenstehenden Feldern ein.">
                                <label for="detail">Extra Info</label>
                            </div>
                        </div>
                    </div>
                </div>
