...
<body>
    <?php
        ...
        $p_0 = " select * from drinks where id = '$id'";
    ...
    <div class="container-xxl bg-white p-0">
                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-primary active" aria-current="page">Drink Modify</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl pt-5 pb-3">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Modify Special Drink</h5>
        ...
        <!-- Delete Button of drink Starts -->
        <form action="admin/php_drink_delete.php" method="post" enctype="multipart/form-data">
        ...
        <!-- Delete Button of drink Ends -->

        <!-- add  drink  Start -->
        <form action="admin/php_drink_modify.php" method="post" enctype="multipart/form-data" id="events">
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="row g-4">
                        <input type='hidden' name='id' value='<?php echo $row['id']; ?>'>
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="form-floating">
                                <input type="text" name="VolCost" class="form-control" value='<?php echo $row['volcost']; ?>' required>
                                <label for="VolCost">Volume & Cost</label>
                            </div>
                        </div>
                                ...
                                <h2 class="text-primary">
                                    <select name="class" id="class" required>
                                        <?php
                                            ...
                                            $p = "SELECT DISTINCT class FROM drinks";

                                            $results = mysqli_query($con, $p);
                                            // echo $result;
                                            $row_counts = mysqli_num_rows($results);

                                            for($j=1; $j<=$row_counts; $j++)
                                            {
                                                $rows = mysqli_fetch_array($results);
                                        ?>
                                           <option value="<?php echo $rows["class"]; ?>" class="text-dark"><?php echo $rows["class"]; ?></option>
                                        <?php
                                           }
                                        ?>
                                    </select> 
