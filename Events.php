...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <?php
                                    ...
                                    {
                                        $eve = mysqli_fetch_array($events); 
                                ?>
                                <a href="Events.php?event=<?php echo $eve["event_start"]; ?>" class="dropdown-item"><?php echo $eve["name"]; ?></a>
                                <?php } ?>
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Up coming Events </h1>
        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="text-center">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Event mit Jay O Food</h5>
        ...
        $event_start = $_GET['event'];

        $qry = "SELECT * FROM events WHERE event_start ='$event_start'";
                ...
                <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="tab-pane fade show p-0">
                            <div class="row g-4">
                                ...
                                <h3 class=" ff-secondary text-start text-primary fw-normal">Reservierung</h3>
                                <h1 class="text-white mb-4 text-center">Tischreservierung online für Event</h1>
                                <form action="table_booked.php" method="post" id="Event_1">

                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="form-floating date" id="date3" data-target-input="nearest">
                                                <input type='hidden' name='rev_date' value='<?php echo $row["event_start"]; ?>' >
                                                <h4 class="text-primary mb-4">Event Name : <?php echo $row["name"]; } ?></h4>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <label>
                                            <p class="text-primary">
                                                <input type="checkbox" name="agree"  class="text-rgba(15, 26, 43, .5) mb-4" required>  Ich akzeptiere die <a href="TableTermConditions.php?page=Events.php"><b><u>Allgemeinen Geschäftsbedingungen.</u></b></a>
                                            </p>
                                        </label>
                                        <div class="col-12">
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="TableTermConditions.php?page=Events.php">Allgemeine Geschäftsbedingungen</a>
                    </div>
                    <?php 
